...
const QMetaObject ListView::staticMetaObject = {
    { &QListWidget::staticMetaObject, qt_meta_stringdata_ListView.data,
      qt_meta_data_ListView,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ListView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Observer"))
        return static_cast< Observer*>(const_cast< ListView*>(this));
