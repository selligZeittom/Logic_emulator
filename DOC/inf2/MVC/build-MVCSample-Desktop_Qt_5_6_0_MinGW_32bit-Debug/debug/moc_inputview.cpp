...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_InputView_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_InputView_t qt_meta_stringdata_InputView = {
    {
QT_MOC_LITERAL(0, 0, 9), // "InputView"
QT_MOC_LITERAL(1, 10, 16), // "onCommandEntered"
QT_MOC_LITERAL(2, 27, 0) // ""

    },
    "InputView\0onCommandEntered\0"
};
...
const QMetaObject InputView::staticMetaObject = {
    { &View::staticMetaObject, qt_meta_stringdata_InputView.data,
      qt_meta_data_InputView,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *InputView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_InputView.stringdata0))
